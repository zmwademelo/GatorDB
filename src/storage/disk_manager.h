...
class DiskManager {
    public: 
        ...
        void WritePage(page_id_t page_id, const char* data);//Use char because we are dealing with raw bytes. And char epresents the most basic unit of addressable memory: a single byte. 
